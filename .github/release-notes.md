**Downloads** (always the newest build)
...
Use **Connect to a PC** to control another computer (a 9-digit ID works from anywhere), or **Share this PC** to let someone connect to yours. Helpers can also connect from any browser at https://tetherdesk.54-151-75-113.nip.io/app

This release is refreshed automatically with every update, so the files here are always current.
